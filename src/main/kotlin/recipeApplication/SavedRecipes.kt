...
class SavedRecipes {
    ...
    val ingredientAmount01A: IngredientAmount = IngredientAmount(Ingr.Egg, 2)
    val ingredientAmount01B: IngredientAmount = IngredientAmount(Ingr.Butter, 1, "EL")
    ...
    val ingredientAmount02B: IngredientAmount = IngredientAmount(Ingr.OatFlakes, 100, "g")
